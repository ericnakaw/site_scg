...
<div class="margin-body-top">
	<div class="container">
		<div>
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Casamento
					...
					<?php foreach ($dados['portfolio'] as $key => $foto) {
						...
						<div class="col-sm-6 col-md-4">
							<div class="w3-container w3-card-2 w3-padding w3-margin-bottom w3-margin-top">
								...
								<div class="">
									<h3>Convite (#<?=$foto->id?>)</h3><button type="button" class="btn btn-sm btn-default" title="<?=$foto->titulo?>" data-toggle="popover" data-placement="right" data-content="<?=$foto->descricao?>"><span class="glyphicon glyphicon-info-sign">Detalhes</span></button>
									<p></p>
								</div>
							</div>
						</div>
